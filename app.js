...
const DATA = {
  ...
  restaurants: [
    ...
    },
    {
      ...
      category: "backup",
      images: ["images/ichinyoan.jpg", "images/ichinyoan_2.jpg", "images/ichinyoan_3.jpg", "images/ichinyoan_4.jpg"],
      links: [
        { label: "公式サイト", url: "https://www.xn--4gq73zd7d.com/" },
        { label: "食べログ", url: "https://tabelog.com/nara/A2904/A290403/29000815/" }
      ],
      badges: [
        { text: "そば百名店・点数最高", cls: "priority-top" }
      ],
      ratings: {
        tabelog: "3.73",
        tabelogReviews: "255",
      ...
      desc: "食べログ「そば WEST 百名店 2025」の山あいの蕎麦店。名物の箱寿司と蕎麦で、今回の候補中で食べログ点数が最も高い。",
      meta: [
    ...
    },
    {
      ...
      category: "backup",
      images: ["images/lucky.jpg", "images/lucky_2.jpg", "images/lucky_3.jpg", "images/lucky_4.jpg"],
      links: [
        { label: "公式サイト", url: "http://www.luckygarden.jp/" },
        { label: "食べログ", url: "https://tabelog.com/nara/A2902/A290201/29000010/" }
      ],
      badges: [
        { text: "通し営業・帰路に寄れる", cls: "priority-alt" }
      ],
      ratings: {
        tabelog: "3.52",
        tabelogReviews: "612",
      ...
      desc: "生駒山の中腹から大阪平野を見下ろすスリランカ料理店。10:00〜21:00の通し営業で、時間が読めない日でも合わせやすい。",
      meta: [
        ["営業", "10:00〜21:00（通し・年中無休）"],
        ["価格", "昼夜とも2,000〜2,999円"],
        ["予約", "基本不要（テラスの一部席のみ要予約）"],
        ["駐車", "20台（第一15・第二5）"],
        ["八尾から", "約25〜30分（北東・生駒山を登る）"],
        ["おふさ観音から", "約40分"]
      ],
      notes: "<strong>予算・営業時間・駐車・眺望は今回の条件に非常に合う。</strong>通し営業なので<strong>帰路の早めの夕食</strong>に使いやすい（17:00橿原発→17:40着→18:40発→19:10八尾）。セイロンミルクティー等でノンアルも充実。ただし<strong>ご当地感は「奈良の郷土料理」ではない</strong>点と、生駒は八尾の北東で<strong>橿原とは逆方向</strong>な点に注意。",
  ...
  legs: [
    ...
    { from: "橿原（おふさ観音）", to: "宇陀・榛原（一如庵）", time: "約30〜35分", note: "東へ山道。14:30終了・駐車7台のため、行くなら開店直後。谷瀬とは両立しない。" },
    { from: "橿原・明日香", to: "生駒（ラッキーガーデン）", time: "約40分", note: "生駒は八尾の北東。橿原とは逆方向だが、生駒→八尾は約25〜30分なので帰路の夕食に使える。" },
