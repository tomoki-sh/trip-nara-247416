...
const DATA = {
  ...
  restaurants: [
    {
      ...
      notes: "<strong>エビ・カニ:</strong> 看板料理ではないが、前菜盛合せ・季節のスープ・パスタが日替わりで魚介を含む可能性あり。予約時にコース内容を確認。<strong>不定休のため当日朝に営業確認を。</strong>",
    ...
    },
    {
      ...
      notes: "<strong>エビ・カニ:</strong> 魚料理・鮑を含むコースやフレンチのソース類あり。看板はエビ・カニではないが、事前相談推奨。最安でも希望予算を上回るため、谷瀬を外す日向き。",
    ...
    },
    {
      ...
      notes: "<strong>エビ・カニ:</strong> 看板は野菜・古代米で、エビ・カニ料理は前面に出ていない。定食の汁物・小鉢・揚げ物は当日確認を。四神の館・ことだまと同じ明日香エリア。",
    ...
    },
    {
      ...
      badges: [
        { text: "アレルギー情報が明快", cls: "priority-top" }
      ],
      ratings: {
        tabelog: "3.40",
        tabelogReviews: "58",
      ...
      notes: "<strong>エビ・カニ:</strong> 公式に「えび・かには基本的に使用しないが季節により限定的に使う場合あり」「厨房・調理機器を食材ごとに分けられない」と明記。<strong>候補中で最も情報が透明</strong>。予約フォームにアレルギー記入欄あり。希望予算は上回る。",
      maps: "五條 源兵衛"
    },
    {
      ...
      notes: "<strong>エビ・カニ:</strong> 柿の葉ずしの主なネタはサバ・サケで、エビ・カニは看板ではない。ただし寿司・海鮮を扱う厨房のため、握りを頼む場合は当日ひとこと伝えておくと安心。",
      maps: "柿の葉ずしヤマト 五條本店"
    },
    {
      name: "ホテル 奈良さくらいの郷",
      ...
      badges: [
        { text: "エビ料理が常設", cls: "priority-warn" }
      ],
      ratings: {
        google: "4.4",
        googleReviews: "213"
      ...
      notes: "<strong>エビ・カニ:</strong> 公式メニューに<strong>有頭エビ付きハンバーグとエビフライが常設</strong>。今回の「エビ・カニを看板にする店は避ける」方針に照らして<strong>優先度を下げる</strong>。利用する場合はフライヤー・器具の共用を電話確認。",
      maps: "ホテル奈良さくらいの郷"
    },
    {
      ...
      notes: "<strong>今回は実質不可:</strong> 8/2（日）の予約は<strong>7/31（金）＝本日が締切</strong>。12〜15時固定のため谷瀬はほぼ不可能。別日の特別デート向き。鮮魚を扱うためエビ・カニの器具共用は要質問。",
    ...
    },
    {
      ...
      desc: "奈良の伝統野菜を打ち出したオーベルジュ。公式にアレルギーの事前申告を案内している。",
      meta: [
  ...
  cafes: [
    {
      ...
      notes: "<strong>混雑・不定休なら無理に待たない。</strong> かき氷のトッピングや市販原材料は当日ひとこと確認すると安心。待ちが長ければ四神の館・博物館へ切り替える。",
      maps: "茶房おふさ 橿原"
    },
    {
      name: "caféことだま",
      ...
      notes: "喫茶（14時以降）は予約不可・来店順。<strong>エビ・カニ:</strong> 甘味・喫茶が中心で看板料理ではない。ランチは品数が多いので、利用するなら内容を確認。四神の館・夢市茶屋と同じ明日香エリアでまとめやすい。",
      maps: "caféことだま 明日香村"
    }
  ],
  ...
  plans: [
    {
      ...
      items: [
        ["11:00", "八尾で同行者をピックアップ（体調・飲み物・予備食を確認）", "確定"],
        ["12:00", "橿原・明日香エリア到着", "確定"],
        ["12:15", "ランチ（Enなど。開始前にエビ・カニをひとこと確認）", "未確定"],
    ...
    },
    {
      ...
      route: "八尾 → 予備食・軽食 → おふさ観音 → 屋内施設 → 八尾",
      items: [
        ["11:00", "八尾でピックアップ（予備食を持参）", "確定"],
  ...
  packing: [
    ...
    {
      group: "同行者の安全",
      items: ["同行者の携行薬（処方があれば）", "安全な予備食（容器包装・えび/かに表示を確認済み）", "保冷バッグ", "健康保険証"]
    },
    {
      group: "猛暑対策",
  ...
  info: [
    ...
    {
      warn: true,
      title: "エビ・カニアレルギー（同行者）",
      text: "今回は「<strong>エビ・カニを看板料理とする店を避ける</strong>」方針で候補を選定済み。ホテル奈良さくらいの郷（有頭エビ・エビフライ常設）は優先度を下げている。店では料理そのものだけでなく出汁・ソース・揚げ油・調理器具の共用も起こり得るため、着席時にひとこと伝えておくと安心。重い症状が出た場合は119番。"
    },
    {
      warn: true,
      title: "おふさ観音の駐車とナビ",
    ...
    },
    {
      warn: false,
      title: "前日・当日の確認",
      text: "天候（橿原・五條・十津川の気温／降水／雷／風）、道路（国道168号・奈良県道路情報）、店舗（営業・駐車場）、おふさ観音の特別案内、車（燃料・ETC・タイヤ・サンシェード）、持ち物（飲料・保冷バッグ・予備食・携行薬・モバイルバッテリー）。"
    },
    {
      warn: false,
      title: "今回見送り・別日に残す候補",
...
const SCHED_VERSION = 1;   // SCHED_DEFAULT を更新したら必ず +1 する
// ref: 地点カードの placeId（"種別:名前"）。付けるとカード/マップと確定状態・並び順が連動する。
const SCHED_DEFAULT = [
  { time: "11:00", text: "八尾でピックアップ（体調・飲み物・予備食を確認）", status: "confirmed", ref: "spot:近鉄八尾駅（集合・解散）" },
  { time: "12:00", end: "12:15", text: "橿原エリア到着", status: "confirmed" },
  { time: "12:15", end: "13:30", text: "ランチ（Enなど。着席時にエビ・カニをひとこと伝える）", status: "tentative", ref: "restaurant:イタリアンtoちょこっと和食En" },
